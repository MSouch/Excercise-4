  ...
  return (
    ...
    >
      <div className="text-center mb-8">
        ...
        />
        <h2 className="text-2xl font-bold text-gray-900">Welcome to Reliability Navigator</h2>
      ...
      <div className="mt-6 text-center">
        <p className="text-xs text-gray-500">
          By continuing, you acknowledge this is a training simulation and agree to complete the program.
        </p>
      </div>
    </motion.div>
  )
