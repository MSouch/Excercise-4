...
const ChallengeQuestion = ({challenge, onComplete}) => {
  ...
  const handleContinueFromFeedback = () => {
    // After excellent feedback, reveal model answer (no auto-timer)
    setShowModelAnswer(true)
  }

  const handleContinueFromModelAnswer = () => {
    // Proceed to exercise explicitly (no auto-timer)
            ...
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-grow">
                ...
                <div className="flex items-center justify-center mt-6">
                  <button
                    onClick={handleContinueFromModelAnswer}
