...
const Conclusion = () => {
  ...
  // Achievement text
      ...
      pdf.setTextColor(75, 85, 99)
      pdf.setFont('helvetica', 'normal')
      pdf.text('has successfully completed the Reliability Navigator training simulation', pageWidth / 2, 100, {align: 'center'})
      pdf.text('and demonstrated mastery of reliability planning principles', pageWidth / 2, 115, {align: 'center'})
      ...
      // Completion Code - Updated to RPN0400
      pdf.setFontSize(10)
      pdf.setTextColor(107, 114, 128)
      pdf.text('Completion Code: RPN0400', 15, pageHeight - 20)
  ...
  const downloadCertificate = () => {
    if (certificateUrl) {
      try {
        ...
        const fileName = `Reliability-Navigator-Certificate-${userName.replace(/\s+/g, '-')}.pdf`
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-2xl font-bold text-gray-900 mb-6 text-center">
              Your Reliability Planning Impact
            </h2>
          ...
          >
            ...
            <p className="text-gray-600 mb-6 text-center">
              Organizations implementing reliability planning approaches like yours report:
            </p>
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <motion.div className="text-center" initial={{opacity: 0, scale: 0.8}} animate={{opacity: 1, scale: 1}} transition={{delay: 0.8, duration: 0.6}}>
                <div className="w-12 h-12 bg-success-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <FaArrowDown className="w-6 h-6 text-green-600" />
                </div>
                <p className="text-2xl font-bold text-green-600 mb-1">37%</p>
                <p className="text-sm text-gray-600">Reduction in equipment failures</p>
              </motion.div>
              <motion.div className="text-center" initial={{opacity: 0, scale: 0.8}} animate={{opacity: 1, scale: 1}} transition={{delay: 0.9, duration: 0.6}}>
                <div className="w-12 h-12 bg-success-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <FaArrowDown className="w-6 h-6 text-green-600" />
                </div>
              ...
              <motion.div className="text-center" initial={{opacity: 0, scale: 0.8}} animate={{opacity: 1, scale: 1}} transition={{delay: 1.0, duration: 0.6}}>
                <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <FaArrowUp className="w-6 h-6 text-primary-600" />
                </div>
                <p className="text-2xl font-bold text-primary-600 mb-1">45%</p>
                <p className="text-sm text-gray-600">Improvement in maintenance effectiveness</p>
              </motion.div>
              <motion.div className="text-center" initial={{opacity: 0, scale: 0.8}} animate={{opacity: 1, scale: 1}} transition={{delay: 1.1, duration: 0.6}}>
                <div className="w-12 h-12 bg-primary-100 rounded-lg flex items-center justify-center mx-auto mb-3">
                  <FaArrowUp className="w-6 h-6 text-primary-600" />
                </div>
                <p className="text-2xl font-bold text-primary-600 mb-1">Overall Event Success</p>
                <p className="text-sm text-gray-600">Positive trend when reliability planning is integrated</p>
              </motion.div>
            </div>
          </motion.div>
          ...
          >
            ...
            <div className="text-center">
              <div className="bg-gradient-to-r from-primary-500 to-success-500 rounded-lg p-6 text-white mb-6">
                ...
                <h3 className="text-xl font-bold mb-2">Certified Reliability Navigator Expert</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              <div className="space-y-3">
                ...
                <ul className="space-y-2 text-gray-600">
                  <li><a href="#" className="underline">Apply MTBF calculations to optimize your next maintenance intervals</a></li>
                  <li><a href="#" className="underline">Implement collaboration protocols with reliability engineers</a></li>
                  <li><a href="#" className="underline">Enhance work packages for your chronic problem equipment</a></li>
                  <li><a href="#" className="underline">Begin tracking reliability improvements from enhanced planning</a></li>
                </ul>
              </div>
              <div className="space-y-3">
