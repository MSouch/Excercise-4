  ...
  const challenges = [
    {
      ...
      description: 'Use failure data and MTBF calculations to optimize maintenance strategies',
      path: '/challenge/1'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      description: 'Adapt reliability approaches across different maintenance contexts',
      path: '/challenge/3'
    },
    {
      id: 4,
      title: 'Reliability-Enhanced Work Package Development',
      description: 'Embed reliability elements that prevent chronic equipment failures',
      path: '/challenge/4'
    }
  ]
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          ...
          <p className="text-gray-600">
            Complete challenges in sequence to unlock the next level and master reliability planning excellence
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            <motion.div
              ...
              transition={{delay: 0.3, duration: 0.5}}
            >
              <h2 className="text-2xl font-bold text-gray-900 mb-2">Reliability Planning Challenges</h2>
              <p className="text-gray-600">
            ...
            >
              ...
              <div className="space-y-2 text-sm text-primary-700">
                <p>• Complete challenges in order - each builds on reliability planning fundamentals</p>
                ...
                {progress.completedChallenges === 4 && (
                  <p className="font-semibold text-success-700">• All challenges complete - generate your Reliability Navigator Expert certificate!</p>
                )}
              </div>
            </motion.div>
          </div>
